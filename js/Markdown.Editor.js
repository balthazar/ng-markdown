(function () {
    ...
    function UIManager(postfix, prefix, panels, undoManager, previewManager, commandManager, helpFunction, getString) {
        ...
        function makeSpritedButtonRow(prefix) {
            ...
            makeSpacer(1);
            buttons.link = makeButton(prefix + "link-button", getString("link"), "markdown-icon-link", bindCommand(function (chunk, postProcessing) {
                return this.doLinkOrImage(chunk, postProcessing, false);
            }));
            buttons.quote = makeButton(prefix + "quote-button", getString("quote"), "markdown-icon-quotes-left", bindCommand("doBlockquote"));
            buttons.code = makeButton(prefix + "code-button", getString("code"), "markdown-icon-code", bindCommand("doCode"));
            buttons.image = makeButton(prefix + "image-button", getString("image"), "markdown-icon-image", bindCommand(function (chunk, postProcessing) {
                return this.doLinkOrImage(chunk, postProcessing, true);
            }));
            makeSpacer(2);
            buttons.olist = makeButton(prefix + "olist-button", getString("olist"), "markdown-icon-numbered-list", bindCommand(function (chunk, postProcessing) {
                this.doList(chunk, postProcessing, true);
            }));
            buttons.ulist = makeButton(prefix + "ulist-button", getString("ulist"), "markdown-icon-list", bindCommand(function (chunk, postProcessing) {
            ...
            if (helpFunction) {
                ...
                helpButton.className = prefix + "button " + prefix + "help-button markdown-icon-question";
